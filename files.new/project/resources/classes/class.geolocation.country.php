...
class GeolocationCountry 
{
	...
	// 	if(!$this->Data)
	// 	{
	// 		$Data = Core::Select("admin_country","*","country_id = ".$this->ID);
	// 		$this->Data = $Data[0];
	// 	}
	// 	return $this->Data;
	// }
	...
	public function GetProvinces()
	{
		if(!$this->Provinces)
		{
			$this->Provinces = Core::Select("admin_country_province","*","country_id = ".$this->ID);
		}
	...
	public function GetZones()
	{
		if(!$this->Zones)
		{
			$this->Zones = Core::Select("admin_country_zone","*","country_id = ".$this->ID);
		}
		return $this->Zones;
	}
