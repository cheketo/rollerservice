        ...
        <div class="col-md-6">
          <div class="flex-allCenter innerContainer">
            <div class="mw100">
              ...
              <div class="form-group">
                <?php echo Core::InsertElement('text','email','','form-control','placeholder="Email" validateEmail="Ingrese un email v&aacute;lido." validateMinLength="4///El email debe contener 4 caracteres como m&iacute;nimo." tabindex="4" validateFromFile='.PROCESS.'///El email ya existe///action:=validate_email///object:=CoreUser"'); ?>
              </div>
              <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  ...
                  <?php echo Core::InsertElement('select','profile','','form-control chosenSelect','validateEmpty="El perfil es obligatorio." tabindex="7" data-placeholder="Seleccione un perfil."',Core::Select('core_profile','profile_id,title',"status='A' AND organization_id=".$_SESSION['organization_id']),' ',""); ?>
                </div>
              </div>
              <!-- Groups -->
              <div class="col-lg-6 col-md-12">
