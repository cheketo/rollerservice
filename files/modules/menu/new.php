          ...
          <h4 class="subTitleB"><i class="fa fa-plus-circle"></i> Complete los campos para agregar un nuevo men&uacute;</h4>
            ...
            <div class="row form-group inline-form-custom-2">
              ...
              <div class="col-xs-12 col-sm-4 inner">
                ...
                <?php echo insertElement('select','parent','','form-control','',Utf8EncodeArray($DB->fetchAssoc('menu','menu_id,title',"status<>'I'")),'0','Men&uacute; Principal'); ?>
              </div>
              <div class="col-xs-12 col-sm-4 inner">
                <label>Link</label>
              ...
              <div class="col-xs-12 col-sm-4 inner">
                ...
                <div class="form-group" id="groups-wrapper">
                  <?php echo insertElement('select','profile','','form-control select2 selectProfileTags','multiple="multiple" data-placeholder="Seleccione Perfiles" style="width: 100%;"',Utf8EncodeArray($DB->fetchAssoc('admin_profile','profile_id,title',"status<>'I' AND company_id = ".$_SESSION['company_id']))); ?>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 inner">
                <label for="">Grupos</label>
                <div class="form-group" id="groups-wrapper">
                  <?php echo insertElement('select','group','','form-control select2 selectGroupTags','multiple="multiple" data-placeholder="Seleccione Grupos" style="width: 100%;"',Utf8EncodeArray($DB->fetchAssoc('admin_group','group_id,title',"status<>'I' AND company_id = ".$_SESSION['company_id']))); ?>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 inner">
