  ...
  <div class="box animated fadeIn" style="min-width:99%">
    <div class="box-header flex-justify-center">
      <div class="innerContainer main_form" style="min-width:100%">
        ...
        <div class="row form-group inline-form-custom">
          <div class="col-xs-12">
              <?php echo Core::InsertElement('text','api_code',$Data['api_code'],'form-control','validateEmpty="Ingrese un c&oacute;digo" validateMinLength="3///Ingrese 3 caracteres" validateMaxLength="3///Ingrese 3 caracteres" placeholder="Ingrese un c&oacute;digo"'); ?>
          </div>
        </div>
        <hr>
        <div class="row txC">
