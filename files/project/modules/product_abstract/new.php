      ...
      <div class="col-md-8 col-sm-6 col-xs-12">
        <div class="innerContainer">
          <h4 class="subTitleB"><i class="fa fa-certificate"></i> Detalles del Art&iacute;culo Gen&eacute;rico</h4>
            ...
            <div class="form-group">
              C&oacute;digo:
              <?php echo Core::InsertElement('text','code','','form-control','placeholder="C&oacute;digo" validateEmpty="Ingrese un c&oacute;digo." validateFromFile="'.PROCESS.'///El c&oacute;digo gen&eacute;rico ingresado ya existe///action:=validate///object:=ProductAbstract"') ?>
            </div>
            <hr>
